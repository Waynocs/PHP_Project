...
class Auth
{
    ...
    {
        $bdd->query("INSERT INTO editor SET surname = ?, name = ?, mail_address = ?, password = ?", [$nom, $prenom, $mail, $password]); //Appel la fonction query de la class Database pour insérer le nouveau rédacteur
